...
const __amountDecimalPipe = new DecimalPipe('it');
...
export function numberToFormattedAmount(n: Number | string):string {
...
export function formettedAmountToNumber(s: string):Number {
  try{
    return new Number(s.replace(/[^\d,-]/g, '').replace(/,/g, '.'));
  }catch(error){
    return 0;
  }
}
...
export const PATTERNS = {
  codiceFiscale: /^(?:[A-Z][AEIOU][AEIOUX]|[B-DF-HJ-NP-TV-Z]{2}[A-Z]){2}(?:[\dLMNP-V]{2}(?:[A-EHLMPR-T](?:[04LQ][1-9MNP-V]|[15MR][\dLMNP-V]|[26NS][0-8LMNP-U])|[DHPS][37PT][0L]|[ACELMRT][37PT][01LM]|[AC-EHLMPR-T][26NS][9V])|(?:[02468LNQSU][048LQU]|[13579MPRTV][26NS])B[26NS][9V])(?:[A-MZ][1-9MNP-V][\dLMNP-V]{2}|[A-M][0L](?:[1-9MNP-V][\dLMNP-V]|[0L][1-9MNP-V]))[A-Z]$/ ,
  codiceFiscaleOPartitaIva: /^(?:[A-Z][AEIOU][AEIOUX]|[B-DF-HJ-NP-TV-Z]{2}[A-Z]){2}(?:[\dLMNP-V]{2}(?:[A-EHLMPR-T](?:[04LQ][1-9MNP-V]|[15MR][\dLMNP-V]|[26NS][0-8LMNP-U])|[DHPS][37PT][0L]|[ACELMRT][37PT][01LM]|[AC-EHLMPR-T][26NS][9V])|(?:[02468LNQSU][048LQU]|[13579MPRTV][26NS])B[26NS][9V])(?:[A-MZ][1-9MNP-V][\dLMNP-V]{2}|[A-M][0L](?:[1-9MNP-V][\dLMNP-V]|[0L][1-9MNP-V]))[A-Z]$|^[0-9]{11}$/ ,
  partitaIva: /^[0-9]{11}$/ ,
  cap: /^[0-9]{5}$/ ,
  importo: /^\d*(\,\d{0,2})?$/ ,
  tipoSoggetto: /^[FG]$/ ,
