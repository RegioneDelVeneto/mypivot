...
export const routes: Routes = [
  ...
  {path: 'flussi', component: FlussiComponent, data:{requiresLogin: true, menuItemId: 20, breadcrumb:{}}, canActivate: [ AccessGuard, ForcedMailValidationGuard ]},
  ...
  {path: 'accertamenti', component: AccertamentiCardComponent, data:{requiresLogin: true, menuItemId: 50, breadcrumb:{}}, canActivate: [ AccessGuard, ForcedMailValidationGuard ]},
  ...
  {path: 'accertamenti/anagrafica', component: AccertamentiCreazioneComponent, data:{requiresLogin: true, menuItemId: 53, breadcrumb:{}}, canActivate: [ AccessGuard, ForcedMailValidationGuard ]},
  ...
  {path: 'visualizzazione/ricevute-telematiche', component: RicevuteTelematicheVisualizzazioneComponent, data:{requiresLogin: true, menuItemId: 63, breadcrumb:{}}, canActivate: [ AccessGuard, ForcedMailValidationGuard ]},
