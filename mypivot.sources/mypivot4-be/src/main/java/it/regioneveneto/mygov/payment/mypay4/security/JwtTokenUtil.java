...
public class JwtTokenUtil {
  ...
  public final static String JWT_CLAIM_TIPO_FLUSSO = "tipoFlusso";
  ...
  public final static String JWT_CLAIM_EMAIL_VALIDATION_ONLY = "emailValOnly";
  ...
  public String generateToken(String username, UserWithAdditionalInfo user) {
    ...
    if(StringUtils.isBlank(user.getEmail()))
      claims.put(JWT_CLAIM_EMAIL_VALIDATION_ONLY, "true");
  ...
  public String generateWsAuthorizationToken(String codIpaEnte, String importPath, String requestToken, String tipoFlusso) {
    Map<String, Object> claims = new HashMap<>();
    claims.put(Claims.SUBJECT, requestToken);
    claims.put(JWT_CLAIM_ENTE,codIpaEnte);
    claims.put(JWT_CLAIM_TIPO_FLUSSO,StringUtils.firstNonBlank(tipoFlusso, "*"));
  ...
  public String generateWsAuthorizationToken(String codIpaEnte, String importPath, String requestToken) {
    return generateWsAuthorizationToken(codIpaEnte, importPath, requestToken, null);
  }
  ...
  public WsImportTo parseWsAuthorizationToken(String token) {
    ...
    wsImportTo.setTipoFlusso(jws.getBody().get(JWT_CLAIM_TIPO_FLUSSO,String.class));
