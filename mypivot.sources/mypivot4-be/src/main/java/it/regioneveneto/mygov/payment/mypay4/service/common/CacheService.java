...
public class CacheService {
  ...
  public final static String CACHE_NAME_MY_PROFILE = "myProfileCache";
  ...
  public final static String CACHE_NAME_TIPO_FLUSSO = "tipoFlussoCache";
