...
public class TesoreriaTo extends BaseTo {

  private Long id;
  private String annoBolletta;
  private String codBolletta;
  private LocalDate dtValuta;
  private LocalDate dtContabile;
  private String idRendicontazione;
  private BigDecimal importoTesoreria;
  private String annoCodDocumento;
  private String codDocumento;
  private String annoCodProvvisorio;
