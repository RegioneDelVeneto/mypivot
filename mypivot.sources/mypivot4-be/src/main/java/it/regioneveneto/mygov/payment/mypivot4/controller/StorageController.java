...
import it.regioneveneto.mygov.payment.mypivot4.dto.UploadTo;
...
public class StorageController {
  ...
  public Object getObject(@PathVariable String tokenId) {
    return storageService.getObject(StorageService.WS_USER, tokenId).orElseThrow(NotFoundException::new);
  }
